# ==============================================================================
# Predefined gene signatures — GeneCardAnalysis
# ==============================================================================
...
#' Get all gene signatures, including custom ones from YAML config
#'
#' @param cfg list; parsed YAML configuration (optional)
...
#' Build a named vector of signature choices for selectInput()
#'
#' @param cfg list; parsed YAML configuration (optional)
#' @return named character vector suitable for shiny::selectInput()
#' @export
